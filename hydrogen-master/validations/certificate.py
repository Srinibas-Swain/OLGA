# run it as python3 certificate.py <verbosity-level>
...
if __name__ == '__main__':
	...
	cert_val1 = Certificate.generate1(graph, verbosity=int(sys.argv[1]))
	cert_val2 = Certificate.generate2(graph, verbosity=int(sys.argv[1]))
